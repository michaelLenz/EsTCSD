############################################################################################################################
# Example of how to use the EsTCSD (Estimate Tissue Cell Size/type Distribution) R package
#
# This example consists of two parts:
# Part 1: Simulation study of real and measured (cross-sectional) cell size distributions (reproduces Figure 2 from the EsTCSD paper)
# Part 2: Correction of adipose tissue cell size distribution using a maximum likelihood approach (using data from one individual and one clinical investigation day of the EsTCSD paper)
# 
# For more details on EsTCSD see:
...
source("EsTCSDcalculations.R") # load EsTCSD functions

############################################
# Part 1:
# Plot real and observed densities for selected uniform, normal, and gamma distributions (Figure 2 of the EsTCSD paper)
############################################
...
############################################
source("EsTCSDcalculations.R") # (re)load EsTCSD functions
# load example data:
