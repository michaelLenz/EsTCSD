...
Hint: The EstiTiCSexampleUsage.R file provides helpful examples on how to use the EstiTiCS code.
...
EstiTiCSexampleUsage.R - Example on how to use the EstiTiCS R script
EstiTiCScalculations.R - Functions performing the EstiTiCS correction
