############################################################################################################################
# Specification of functions used to estimate tissue cell size distributions from cross-section images via EsTCSD 
# (Estimate Tissue Cell Size/type Distribution)
# For an example usage of these functions see "EsTCSDexampleUsage.R"
# 
...
###########################################
# Implementation of the functions to determine the measured distribution from the given true cell radii distribution (Equation 6 of the EsTCSD paper)
###########################################

# Calculation of the normalization factor (denomiator) of Equation 6 of the EsTCSD paper:
